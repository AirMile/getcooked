            ...
            <div class="flex items-center gap-8">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('recipes.index', ['filter' => 'saved'])" :active="request()->routeIs('recipes.index') && request('filter') === 'saved'">
                            {{ __('Saved Recipes') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <x-responsive-nav-link :href="route('recipes.index', ['filter' => 'saved'])" :active="request()->routeIs('recipes.index') && request('filter') === 'saved'">
                    {{ __('Saved Recipes') }}
                </x-responsive-nav-link>
            @endif
        </div>
