...
{{-- Collection Page Filters: Source, Difficulty, Cook Time, Meal Type --}}
<div x-data="filterManager({{ json_encode($filters) }})" class="p-4">
    ...
    {{-- Source Filter (Own Public, Own Private, Saved) --}}
    <div class="mb-4">
        <h4 class="text-sm font-medium text-gray-700 mb-2">Source</h4>
        <div class="space-y-2">
            <label class="flex items-center">
                <input type="checkbox" value="own_public" :checked="filters.source.includes('own_public')" @click="toggleFilter('source', 'own_public')" class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
                <span class="ml-2 text-sm text-gray-600">My Public Recipes</span>
            </label>
            <label class="flex items-center">
                <input type="checkbox" value="own_private" :checked="filters.source.includes('own_private')" @click="toggleFilter('source', 'own_private')" class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
                <span class="ml-2 text-sm text-gray-600">My Private Recipes</span>
            </label>
            <label class="flex items-center">
                <input type="checkbox" value="saved" :checked="filters.source.includes('saved')" @click="toggleFilter('source', 'saved')" class="rounded border-gray-300 text-primary-600 focus:ring-primary-500">
                <span class="ml-2 text-sm text-gray-600">Saved Recipes</span>
            </label>
        </div>
    </div>
