    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center gap-4 mb-8 px-4 sm:px-0">
                <button onclick="localStorage.removeItem('recipe_form_create'); window.history.back();" class="p-2 border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 rounded-md transition-colors duration-base" title="Back">
